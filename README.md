...
>
> The Ethernet port on the BYD BMU is not documented for diagnostic use in the product manual. Its availability is purely coincidental and may change with firmware updates without notice.
>
...
> - Incorrect readings may occur due to communication errors or firmware differences
>
