...
DISCLAIMER = """
  ...
  │                                                                                  │
  │  The Ethernet port and its Modbus protocol on the BYD BMU are not documented     │
  │  in the product manual for diagnostic use by end-users or installers. Their      │
  │  availability and open accessibility are purely coincidental and may change      │
  │  with firmware updates without notice. The consequences of frequent or           │
  │  continuous Modbus polling on the BMU are unknown.                               │
  │                                                                                  │
  │  By using this software, you acknowledge and agree that:                         │
  │  - The author assumes NO liability for any damages, loss of warranty,            │
  │    or other consequences whatsoever                                              │
  ...
  │  - Incorrect readings may occur due to register misinterpretation,               │
  │    communication errors, or firmware differences                                 │
  │                                                                                  │
  │  Data interpretation by this tool (including but not limited to warranty         │
  │  estimates, cycle counts, efficiency calculations, and cell drift analysis)      │
  │  reflects the author's understanding and may not be accurate. Always consult     │
  │  official BYD documentation or an authorized service partner for definitive      │
  │  assessments.                                                                    │
  │                                                                                  │
  │  By your first use of this software, you irrevocably accept all of the above     │
  │  terms.                                                                          │
  │                                                                                  │
